        ...
        try {
            ...
            if (session.getAttribute("token") != null) {
                ...
                if (token.length() > 30) {
                    ...
                    System.out.println("Current user: "+ profileInfo.getBody());
//
//
    ...
    public String searchNotification(@RequestParam(value = "searchword", required = false) String searchword,
        ...
        try {
            System.out.println("Search word in If statement: "+ searchword);
            ...
            if (session.getAttribute("token") != null) {
                ...
                if (token.length() > 30) {
                    ...
                    if (searchword == null || searchword.isEmpty()) {
                        System.out.println("Search word in If statement: "+ searchResults);
                        searchResults = notifications;
                    } else {
                        System.out.println("Search word in else statement: "+ searchResults);
